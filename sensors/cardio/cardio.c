...
/*---------------------------------------------------------------------------*/
PROCESS_NAME(cardio_process);
AUTOSTART_PROCESSES(&cardio_process);
...
/*---------------------------------------------------------------------------*/
PROCESS_THREAD(cardio_process, ev, data)
{
  ...
  // Broker registration                     
  mqtt_register(&conn, &cardio_process, client_id, mqtt_event,
