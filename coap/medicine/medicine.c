...
#define SENSOR_TYPE "{\"deviceType\": \"\", \"sensorId\": -1}"
...
extern coap_resource_t res_number_1;
extern coap_resource_t res_number_2;
...
PROCESS_THREAD(light_server, ev, data){
	...
	coap_activate_resource(&res_number_1, "medicine/risorsa1"); 
	coap_activate_resource(&res_number_2, "medicine/risorsa2"); 
