...
/* Log configuration */
#include "sys/log.h"
#define LOG_MODULE "mask"
#define LOG_LEVEL LOG_LEVEL_DBG

#define INTERVAL_BETWEEN_CONNECTION_TESTS 1

extern coap_resource_t res_oxygen;
...
PROCESS(mask_server, "Mask Server");
AUTOSTART_PROCESSES(&mask_server);

PROCESS_THREAD(mask_server, ev, data){
	PROCESS_BEGIN();
	...
	LOG_INFO("Starting CoAP-Mask\n");
	coap_activate_resource(&res_oxygen, "mask"); 
